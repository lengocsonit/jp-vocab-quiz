...
- Icon cạnh điểm mỗi người thay đổi theo **cấp bậc tích luỹ** (không còn 1 icon cúp cố định): 🌱 Tân binh (0đ) → 🥋 Học viên (1.000đ) → ⚔️ Chiến binh (3.000đ) → 🔥 Cao thủ (6.000đ) → 👑 Bậc thầy (10.000đ) → 💎 Huyền thoại (20.000đ). Di chuột vào icon để xem tên cấp bậc.
- Sau khi hoàn thành 1 lượt chơi, màn kết quả hiện thêm khung chúc mừng: số điểm rèn luyện vừa ghi thêm, chuỗi ngày làm bài liên tiếp, và hạng hiện tại trên bảng xếp hạng Tổng (vd "Bạn đang xếp hạng #4 toàn hệ thống — cố gắng lên nhé!").
- **Chuỗi ngày làm bài liên tiếp (streak)**: tính thẳng từ dữ liệu `History` có sẵn (không lưu sheet riêng), nên tự động đúng với toàn bộ lịch sử đã chơi từ trước, không cần thiết lập hay tính lại gì thêm. Mỗi ngày làm ít nhất 1 lượt (nộp bài) thì chuỗi tăng thêm 1 (ngày tính từ 0:00, chỉ tính 1 lần/ngày dù chơi nhiều lượt). Nghỉ tối đa 2 ngày liên tiếp không làm bài vẫn giữ nguyên chuỗi; nghỉ quá 2 ngày thì chuỗi coi như đứt (về 0, rồi tính lại từ 1 ở lượt chơi kế tiếp). Hiển thị icon lửa 🔥 cạnh tên trên bảng xếp hạng, "nóng" dần theo số ngày (🔥 → 🔥🔥 từ 7 ngày → 🔥🔥🔥 từ 14 ngày → 🔥💯 từ 30 ngày) để khuyến khích duy trì thói quen học mỗi ngày.
