...
- **Chuỗi ngày làm bài liên tiếp (streak)**, lưu riêng theo từng tên vào tab `Streaks` (tự tạo, không cần thiết lập gì thêm): mỗi ngày làm ít nhất 1 lượt (nộp bài) thì chuỗi tăng thêm 1 (ngày tính từ 0:00, chỉ tính 1 lần/ngày dù chơi nhiều lượt). Nghỉ tối đa 2 ngày liên tiếp không làm bài vẫn giữ nguyên chuỗi; nghỉ quá 2 ngày thì chuỗi tự reset về 1 khi làm bài trở lại. Hiển thị icon lửa 🔥 cạnh tên trên bảng xếp hạng, "nóng" dần theo số ngày (🔥 → 🔥🔥 từ 7 ngày → 🔥🔥🔥 từ 14 ngày → 🔥💯 từ 30 ngày) để khuyến khích duy trì thói quen học mỗi ngày.
