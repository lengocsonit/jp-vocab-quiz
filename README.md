...
- Icon cạnh điểm mỗi người thay đổi theo **cấp bậc tích luỹ** (không còn 1 icon cúp cố định): 🌱 Tân binh (0đ) → 🥋 Học viên (50đ) → ⚔️ Chiến binh (150đ) → 🔥 Cao thủ (300đ) → 👑 Bậc thầy (500đ) → 💎 Huyền thoại (1000đ). Di chuột vào icon để xem tên cấp bậc.
