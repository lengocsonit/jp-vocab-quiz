...
- Danh sách lĩnh vực (số lượng từ/câu, loại Từ vựng hay Test) được cache lại 10 phút phía Apps Script để trang chủ tải nhanh dù có nhiều sheet — cache tự xoá ngay khi bạn thêm lĩnh vực mới (qua menu hoặc Import CSV), nhưng nếu chỉ **thêm dòng vào 1 sheet đã có sẵn**, số lượng hiển thị có thể mất tối đa 10 phút mới cập nhật (không ảnh hưởng đến nội dung học, chỉ là con số đếm).
